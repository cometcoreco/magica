                            ...
                            @if (env('APP_STATUS') == 'Demo')
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="gcs_file" name="gcs_file"
                                            placeholder="*********************" value="*********************">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('GCS Project Name') }}</label>
                                        <input type="text" class="form-control" id="gcs_name" name="gcs_name"
                                            placeholder="{{ __('my-project-123') }}" value="*********************">
                                    </div>
                                </div>
                            @else
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="feature_tts_google"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('ElevenLabs API Key') }}</label>
                                        <input type="text" class="form-control" id="elevenlabs_api_key" name="elevenlabs_api_key"
                                            placeholder="ElevenLabs API Key" value="{{ $settings_two->elevenlabs_api_key }}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('GCS File (JSON) path') }}</label>
                                        <input type="text" class="form-control" id="gcs_file" name="gcs_file"
                                            placeholder="googlefile.json" value="{{ $setting->gcs_file }}">
                                        <div
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('GCS Project Name') }}</label>
                                        <input type="text" class="form-control" id="gcs_name" name="gcs_name"
                                            placeholder="{{ __('my-project-123') }}" value="{{ $setting->gcs_name }}">
                                    </div>
                                </div>
                            @endif
